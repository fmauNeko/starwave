...
### Music & Voice Subsystem

The music subsystem — queue, provider plugins, YouTube streaming (PoToken + cookie auth), now-playing UI, slash commands — and its `voice/` playback layer are documented in **[src/discord/music/AGENTS.md](src/discord/music/AGENTS.md)**.
...
| Music & voice subsystem | [`src/discord/music/AGENTS.md`](src/discord/music/AGENTS.md) |
...
> Music, voice, and YouTube playback gotchas → [src/discord/music/AGENTS.md](src/discord/music/AGENTS.md).
